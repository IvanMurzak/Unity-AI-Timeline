...
namespace com.IvanMurzak.Unity.MCP.Timeline.Installer.Tests
{
    public class ManifestInstallerTests
    {
        ...
        const string FilesRoot = "Assets/com.IvanMurzak/AI Timeline Installer/Tests/Files";
        const string FilesCopyRoot = "Temp/com.IvanMurzak/AI Timeline Installer/Tests/Files";

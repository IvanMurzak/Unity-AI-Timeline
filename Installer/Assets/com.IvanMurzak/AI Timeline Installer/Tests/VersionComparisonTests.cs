...
using com.IvanMurzak.Unity.MCP.Timeline.Installer.SimpleJSON;

namespace com.IvanMurzak.Unity.MCP.Timeline.Installer.Tests
{
    public class VersionComparisonTests
    {
        const string TestManifestPath = "Temp/com.IvanMurzak.Unity.MCP.Timeline.Installer.Tests/test_manifest.json";
        const string PackageId = "com.ivanmurzak.unity.mcp.timeline";

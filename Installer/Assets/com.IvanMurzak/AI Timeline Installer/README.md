...
#### 3️⃣ Customize `Packages/com.ivanmurzak.unity.mcp.timeline/package.json`
...
#### 4️⃣ Add files into `Packages/com.ivanmurzak.unity.mcp.timeline` folder
...
- Copy the updated `README.md` to `Packages/com.ivanmurzak.unity.mcp.timeline` as well.

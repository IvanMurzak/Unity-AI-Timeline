...
- Reads the current version from `Unity-Package/Packages/com.ivanmurzak.unity.mcp.timeline/package.json`.
- Updates these files atomically:
  - `Unity-Package/Packages/com.ivanmurzak.unity.mcp.timeline/package.json` — `"version": "X.Y.Z"`

...
├── Unity-Package/            # The package source — only `Packages/com.ivanmurzak.unity.mcp.timeline/` ships
│   └── Assets/
...
> Anything outside `Unity-Package/Packages/com.ivanmurzak.unity.mcp.timeline/` is NOT shipped to consumers.
...
- **Dependency:** `com.ivanmurzak.unity.mcp` v0.68.0 (declared in `Unity-Package/Packages/com.ivanmurzak.unity.mcp.timeline/package.json`)
...
- **Editor tool** → put under `Unity-Package/Packages/com.ivanmurzak.unity.mcp.timeline/Editor`
  - Works in Edit Mode and Play Mode in the Editor.
  - Has access to Editor APIs.
  - NOT shipped in game builds.
- **Runtime tool** → put under `Unity-Package/Packages/com.ivanmurzak.unity.mcp.timeline/Runtime`
  - Works in Edit Mode and Play Mode in the Editor.
